/*
  ...
  1. Functions
    - `check_task_completion`: Checks if all fields in a task are filled
    - `get_lecture_progress`: Gets progress for a specific lecture
    - `get_overall_progress`: Gets overall progress for a student
