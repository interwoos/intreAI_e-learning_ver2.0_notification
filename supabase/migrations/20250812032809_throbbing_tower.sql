/*
  ...
  1. New Tables
    - `chat_history`
      ...
      - `timestamp` (timestamptz) - メッセージ送信時刻
  ...
  3. Performance
    ...
    - Optimize for user_id + task_id + timestamp queries
*/
...
CREATE INDEX idx_chat_history_user_task_timestamp ON chat_history(user_id, task_id, timestamp DESC);
