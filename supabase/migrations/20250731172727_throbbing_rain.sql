/*
  # 事前課題管理とチャットプロンプトプリセット機能のテーブル作成（修正版）
  ...
  1. New Tables
    ...
    - `prompt_presets` - チャットプロンプトプリセット保存用テーブル
...
-- チャットプロンプトプリセット保存用テーブル（チャットプロンプトのみ）
...
-- prompt_presets のポリシー（チャットプロンプトのみ）
